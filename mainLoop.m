...
MinJerkTrajectory.plot_paths(xuaj_des, dt, "start and end acceleration")
y_des = transpose(xuaj_des(1,:));
...
impact_timesteps = ones(1, N);
impact_timesteps(1:2) = 2;
...
tic
    ...
    dup = ilc_kf.updateStep(u_des, transpose(x_p));
toc

classdef DynamicSystem < matlab.System
    ...
    function [Ad, Bd, Cd, S, c] = getSystemMarixesForceControl(obj,dt)
        %METHOD1 Summary of this method goes here
        %   Detailed explanation goes here
        mbp = 1/(obj.m_p+obj.m_b);
        Ad = [ 1 0 dt/2*(2-obj.m_p*mbp)  dt/2*obj.m_p*mbp   ; ...
               0 1 dt/2*obj.m_b*mbp      dt/2*obj.m_b*mbp   ; ...
               0 0 1-obj.m_p*mbp         obj.m_p*mbp        ; ...
               0 0 obj.m_b*mbp           obj.m_b*mbp        ];
           
       Bd = [mbp*dt^2/2                         ; ...
             1/obj.m_p*dt^2/2*(1-obj.m_b*mbp)   ; ...
             dt*mbp                             ; ...
             dt*obj.k_c*(1-obj.m_b*mbp)         ];

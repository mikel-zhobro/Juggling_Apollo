classdef Simulation < matlab.System
   ...
   methods
    ...
    function [x_b, u_b, x_p, u_p, dP_N_vec, gN_vec] = simulate_one_iteration(obj, dt, T, x_b0, x_p0, u_b0, u_p0, u)
        ...
        x_b_1 = zeros(1,N+1); x_b_1(1) = x_b0;
        u_b_1 = zeros(1,N+1); u_b_1(1) = u_b0;
        x_p_1 = zeros(1,N+1); x_p_1(1) = x_p0;
        u_p_1 = zeros(1,N+1); u_p_1(1) = u_p0;
        dP_N_vec_1 = zeros(1,N+1);
        gN_vec_1 = zeros(1,N+1);
        Fp_vec_1 = zeros(1,N+1);


        % Simulation
        for i = (1:N)
            % one step simulation
            [x_b_new, x_p_new, u_b_new, u_p_new, dP_N, gN]      = obj.simulate_one_step(dt, u(i), x_b(i), x_p(i), u_b(i), u_p(i));
            ...
            % simulation using matrixes
            [x_b_new1, x_p_new1, u_b_new1, u_p_new1, dP_N1, gN1] = obj.state_space_one_step(dt, u(i), x_b_1(i), x_p_1(i), u_b_1(i), u_p_1(i));
            % collect states
            x_b_1(i+1) = x_b_new1;
            x_p_1(i+1) = x_p_new1;
            u_b_1(i+1) = u_b_new1;
            ...
            u_b_new-u_b_new1
            display([x_b_new-x_b_new1, x_p_new-x_p_new1, u_b_new-u_b_new1, dP_N-dP_N1, gN-gN1])
        end
        
        Simulation.plot_results(dt, Fp_vec_1, x_b_1, u_b_1, x_p_1, u_p_1, dP_N_vec_1, gN_vec_1)
    end
    ...
    function [x_b_new, x_p_new, u_b_new, u_p_new, dP_N, gN] = simulate_one_step(obj, dt, u_i, x_b_i, x_p_i, u_b_i, u_p_i)
    ...
    function [x_b_new, x_p_new, u_b_new, u_p_new, dP_N, gN] = state_space_one_step(obj, dt, u_i, x_b_i, x_p_i, u_b_i, u_p_i)
        ...
        dP_N = 0;
        if contact_impact
            dP_N = max(0,(-gamma_n_i + obj.g*dt + obj.force_from_velocity(u_i, u_p_i)*dt/obj.m_p)/ (obj.m_b^-1 + obj.m_p^-1));
        end
    end
   end
